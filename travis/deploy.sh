...
sed -i "s+DMV_AGENT_ID_HERE+$DMV_AGENT_ID+g" $DEPLOYMENT_SPEC
...
sed -i "s+IBMHR_AGENT_ID_HERE+$IBMHR_AGENT_ID+g" $DEPLOYMENT_SPEC
...
sed -i "s+BBCU_AGENT_ID_HERE+$BBCU_AGENT_ID+g" $DEPLOYMENT_SPEC
...
sed -i "s+HR_AGENT_DID_HERE+$IBMHR_AGENT_DID+g" $DEPLOYMENT_SPEC
sed -i "s+DMV_AGENT_DID_HERE+$DMV_AGENT_DID+g" $DEPLOYMENT_SPEC
